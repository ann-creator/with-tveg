...
from mat import water_mat, UO2_mat, cladding_mat, mixed_with_Gd2O3_mat, helium_mat, tube_mat
openmc.config['cross_sections']='/home/ann/PycharmProjects/1000/library/jeff33/jeff-3.3-hdf5/cross_sections.xml'
#openmc.config['cross_sections'] = '/home/ann/PycharmProjects/1000/library/endfb71/endfb-vii.1-hdf5/cross_sections.xml'
import matplotlib.pyplot as plt
from geomety_with_tveg import universe
from openmc import interp1d
from params import GeometryParams
import numpy as np
if __name__ == "__main__":
    materials = openmc.Materials([UO2_mat, water_mat, cladding_mat, helium_mat, tube_mat, mixed_with_Gd2O3_mat])
    ...
    colors = {water_mat: (120, 120, 255), cladding_mat: 'black', UO2_mat: (0, 200, 0), mixed_with_Gd2O3_mat: (0, 100, 0)}
